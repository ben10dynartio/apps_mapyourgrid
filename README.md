...
- `indicators_map/` : Generate the global indicator map (rendered here: [https://mapyourgrid.dynartio.com/gridinspector/](https://mapyourgrid.dynartio.com/gridinspector/))
